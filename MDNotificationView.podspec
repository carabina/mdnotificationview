#
#  Be sure to run `pod spec lint MDNotificationView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
	...
	MDNotificationView provides customizable views that slide in from the top or the bottom. They may contain a title, a text, an image and an action button.
